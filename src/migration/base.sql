...
INSERT INTO mydb.news (title, content, match_id, tour_id, sport_id)
VALUES 
    ('GT vs RCB', 'RCB won the mathc by 23 runs', 1, 1, 1),
    ('IND vs WI', 'Shami took 4 wickets in a row', 9, 2, 2),
    ('LSG vs KXIP', 'LSG lost match by 2 wickets', 3, 3, 1);
